package com.hjy.sacore.base.support;
...
import com.hjy.sacore.base.helper.GsonHelper;
import com.hjy.sacore.base.helper.NetHelper;
import com.hjy.sacore.base.model.LogInfo;
import com.hjy.sacore.base.model.MDataMap;
import com.hjy.sacore.base.model.SendLog;
import com.hjy.sacore.baseclass.BaseClass;
import com.hjy.sacore.top.cache.LogCache;
import com.hjy.sacore.top.topdo.TopConst;
import com.hjy.sacore.top.topdo.TopDir;
			...
			synchronized (LogSupport.class) {
				if (null == instance) {
					...
					serverCode = NetHelper.getLocalIP() + ":"
							+ StringUtils.substringAfterLast(new TopDir().upServerletPath(""), "/");
				}
			}
		}
		return instance;
