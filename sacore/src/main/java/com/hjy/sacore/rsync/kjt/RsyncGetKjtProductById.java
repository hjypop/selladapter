package com.hjy.sacore.rsync.kjt;
...
import com.hjy.sacore.base.helper.BeansHelper;
import com.hjy.sacore.base.helper.JsonHelper;
import com.hjy.sacore.base.model.MDataMap;
import com.hjy.sacore.baseconst.MemberConst;
import com.hjy.sacore.entity.productcenter.PcProductflow;
import com.hjy.sacore.entity.productcenter.PcProductinfo;
import com.hjy.sacore.rsync.config.kjt.RsyncConfigGetKjtProductById;
import com.hjy.sacore.rsync.config.kjt.RsyncKjt;
import com.hjy.sacore.rsync.model.RsyncDateCheck;
import com.hjy.sacore.rsync.model.RsyncResult;
import com.hjy.sacore.rsync.model.kjt.RsyncModelGetKjtProduct;
import com.hjy.sacore.rsync.response.kjt.RsyncResponseGetKjtProductById;
import com.hjy.sacore.rsync.request.kjt.RsyncRequestGetKjtProductById;
import com.hjy.sacore.util.DateUtil;
import com.hjy.sacore.web.helper.WebHelper;
import com.hjy.sacore.web.model.MWebResult;
		...
		if (result.upFlagTrue()) {
			...
			if (result.getProcessNum() > 0) {
				...
				result.setProcessData(
						bInfo(918501102, result.getProcessNum(), iSuccessSum, result.getProcessNum() - iSuccessSum));
...
//			List<Map<String, Object>> list = DbUp.upTable("pc_productinfo").dataSqlList(
//					"SELECT p.product_code,p.product_shortname,p.max_sell_price,p.min_sell_price,p.product_name,p.cost_price,d.description_info,p.update_time FROM pc_productinfo p LEFT JOIN pc_productdescription d on p.product_code=d.product_code where p.product_code_old=:product_code_old and p.seller_code=:seller_code ",
...
//				ProductService productService = BeansHelper
...
//				new ProductService().UpdateProductTx(productinfo, new StringBuffer(), "jobsystem",
...
//		productinfo.setPcProductinfoExt(pcProductinfoExt);
	...
	/**
	 * @Description:插入商品历史流水信息 @param productinfo 商品信息实体 @param
...
//		com.IPcProductflowDao.dborm.txmapper.PcProductflowMapper ppfm = BeansHelper
