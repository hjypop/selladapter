package com.hjy.sacore.web.helper;
...
import com.hjy.sacore.base.helper.SecrurityHelper;
import com.hjy.sacore.base.model.MDataMap;
import com.hjy.sacore.top.topdo.TopUp;
import com.hjy.sacore.web.inter.IWebStatic;
import com.hjy.sacore.web.webdo.WebConst;
...
public class WebHelper {
	...
	public static String upCode(String sCodeStart) {
		 ...
		 * DbUp.upTable("zw_webcode").dataSqlOne( "call proc_zw_getcode(:code);"
		 * , new MDataMap("code", sCodeStart)); return
		 * mResultMap.get("webcode").toString();
		 */
		// return DataDo.upCode(sCodeStart);
		return null;
	}
	...
	public static String addLock(int timeOutSeconds, String... keys) {
		...
		//
		// Map<String, Object> mResultMap =
		// DbUp.upTable("zw_webcode").dataSqlOne(
		// "call
		// proc_lock_or_unlock_somekey(:somekey,',',:timeoutsecond,1,:uuid);",
		// mDataMap);
		//
	...
	public static String unLock(String uuid) {
		...
		//
		// Map<String, Object> mResultMap = DbUp.upTable("zw_webcode")
		// .dataSqlOne("call proc_lock_or_unlock_somekey('',',',0,2,:uuid);",
		// mdataMap);
		//
		// if (mResultMap.get("outFlag").toString().equals("1"))
		// return uuid;
	...
	//
	// lSqlStrings.add(mField.getColumnName() + " as " + mField.getFieldName());
	// }
	// }
	 ...
	 */
	public static void errorMessage(String sCode, String sErrorType, int iErrorLevel, String sErrorSource,
			String sMessage, Exception e) {
		...
		try {
			...
			// "error_type", sErrorType, "error_level",
	...
	public static String upStaticValue(IWebStatic iStatic) {
		...
		// "static_code=:static_code", "static_code",
		// iStatic.upCode());
		//
		// if (mStaticMap != null) {
	...
	public static boolean updateStaticValue(IWebStatic iStatic, String sValue) {
		...
		mDataMap.inAllValues("static_code", iStatic.upCode(), "update_time", FormatHelper.upDateTime(), "static_info",
				sValue);
