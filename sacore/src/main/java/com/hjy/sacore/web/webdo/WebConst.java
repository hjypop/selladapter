package com.hjy.sacore.web.webdo;

import com.hjy.sacore.base.inter.IBaseConst;
...
public class WebConst implements IBaseConst {
	 ...
	 * MOBILE版form字段
	 */
	public final static String CONST_WEB_MOBILE_FORM = "zm_f_";
	...
	/**
	 * 定义API处理类中的各种扩展参数的名字起始
	 */
	public final static String CONST_APIFACTORY_FOR_PARAM = "apifactory_for_extend_";
